...
const subRoutes: Record<string, Record<string, string>> = {
  ...
  Categories: {
    "Pure Spices": "/shop?category=All+Products",
    "Blended Masalas": "/shop?category=All+Products",
    "Whole Spices": "/shop?category=All+Products",
    "Recipes": "/recipes",
  },
  Brands: {
    "Roopak": "/brands",
  ...
  Bundles: {
    "Starter Bundle": "/bundles?bundle=starter",
    "Biryani Bundle": "/bundles?bundle=biryani",
    "Non-Veg Bundle": "/bundles?bundle=nonveg",
    "Gift Bundle": "/bundles?bundle=gift",
  },
  Recipes: {
    "Quick Meals": "/recipes?category=quick",
    "North Indian": "/recipes?category=north-indian",
    "Biryani & Rice": "/recipes?category=biryani",
    "Grills & Kebabs": "/recipes?category=grills",
  },
  Wholesale: {
...
export default function MobileMenu({ isOpen, setIsOpen }: { isOpen: boolean, setIsOpen: (v: boolean) => void }) {
  ...
  const menuStruct: Record<string, string[]> = {
    ...
    Categories: ["Pure Spices", "Blended Masalas", "Whole Spices", "Recipes"],
    Brands: ["Roopak", "Shan-E-Delhi", "Nawab Secret", "Noori"],
    Bundles: ["Starter Bundle", "Biryani Bundle", "Non-Veg Bundle", "Gift Bundle"],
    Recipes: ["Quick Meals", "North Indian", "Biryani & Rice", "Grills & Kebabs"],
